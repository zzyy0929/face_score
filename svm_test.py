...
if __name__ == '__main__':
    ...
    #     用图片测试
    frame = cv2.imread("/home/zzy/face_rank/face_score_test/3.jpg")
    ...
    # print(score_1)
    #
    # score=score_1[0]*0.7+score_1[1]*0.2+score_1[2]*0.1+score_2[0]*0.5+score_2[1]*0.3+score_2[2]*0.2
    # score=score/2
    text="Your classfication result is "+str(score)
    print(text)
